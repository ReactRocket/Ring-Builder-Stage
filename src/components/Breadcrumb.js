    ...
    <section className=" h-auto w-full flex flex-col gap-3 overflow-hidden">
      ...
      <section
        className={` border border-[#E6E6E6]  ${
          location.pathname === "/complete" && "bg-[#804294]"
              ...
              <div className="h-full w-[15%] flex justify-center items-center ">
                ...
                >
                  <path
                    ...
                    fill={
                      location.pathname === "/diamond" ? "white" : "#464646"
                    }
                  />
                </svg>
              </div>
              ...
              <div className="h-full w-[15%] flex justify-center items-center">
                ...
                >
                  <path
                    ...
                    fill={
                      location.pathname === "/setting" ? "white" : "#464646"
                    }
                  />
                  <path
                    fill-rule="evenodd"
                ...
                >
                  <g clip-path="url(#clip0_162_8166)">
                    <path
                      ...
                      fill={
                        location.pathname === "/complete" ? "white" : "#464646"
                      }
                    />
                    <path
